          ...
          <div className="row isFlex detailMainStyle ">
            <div className="col-sm-6 col-xs-12 film left mt100 ">
              ...
              <div className="row rowLeftInfo">
                ...
                <p className="contentInfo ng-binding">22.03.2019</p>
              </div>
              {/* Finish row Info */}
              {/* Start row Info */}
              <div className="row rowLeftInfo">
                <p className="contentTitle">Đạo diễn</p>
                <p className="contentInfo ng-binding"> Jordan Peele </p>
              </div>
              {/* Finish row Info */}
              <div className="row rowLeftInfo">
              ...
              <div className="row rowLeftInfo">
                ...
                <p className="contentInfo ng-binding">Kinh dị</p>
              </div>
              <div className="row rowLeftInfo">
            ...
            <div className="col-sm-6 col-xs-12 film right mt100">
              <div className="row rowLeftInfo">
