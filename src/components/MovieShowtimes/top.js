              ...
              <div className="item" >
                <div className="movie-box-1">
                  <div className="poster">
                    <img src="https://s3img.vcdn.vn/mobile/123phim/2019/03/us-chung-ta-15517779531412_220x310.jpg" />
                  </div>
                  <div className="buttons">
                    <a href="https://www.youtube.com/watch?v=3T9c42gxXzg" className="play-video">
                      <i className="fa fa-play" /></a></div>
                </div>
              </div>
            </div>
            {/* Finish Poster Film */}
